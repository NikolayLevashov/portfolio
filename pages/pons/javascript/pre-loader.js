...
(function ($) {
  ...
  $.fn.krutilka = function (o) {
    var options = {
      size: 45, // Ширина и высота блока с крутилкой
      petals: 10, // Сколько лепестков у крутилки
      petalWidth: 3, // Толщина лепестка
      petalLength: 10, // Длина лепестка
      petalOffset: 5, // Внутреннее поле блока с крутилкой (расстояние до кончика лепестка)
      time: 2000, // Время прохода круга в миллисекундах
      color: '#03AF30', // Цвет лепестков
